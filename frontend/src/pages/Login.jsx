...
export default function Login() {
  ...
  const DEMO_USERS = [
    { label: 'SuperAdmin', email: 'superadmin@talleresbobby.pe', pw: 'SuperBobby2024!', color: '#F7C416', text: '#073590' },
    { label: 'Admin',      email: 'admin@talleresbobby.pe',      pw: 'AdminBobby2024!', color: '#073590', text: 'white' },
    { label: 'Usuario',    email: 'user@talleresbobby.pe',       pw: 'UserBobby2024!',  color: '#f0f4ff', text: '#073590' },
  ]
      ...
      <div className="login-card">
        ...
        <form onSubmit={handleSubmit} className="login-form">
          <div className="form-group">
            ...
            <input type="email" placeholder="admin@talleresbobby.pe" value={form.email}
        ...
        <div className="login-demo">
          <p className="login-demo__label">Cuentas de demostración</p>
          {DEMO_USERS.map(u => (
            <button key={u.label} className="login-demo__btn" style={{ background: u.color, color: u.text }}
